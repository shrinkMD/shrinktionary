---
title: "Psychiatrist vs psychologist vs therapist"
slug: psychiatrist-vs-psychologist-vs-therapist
short_answer: "A psychiatrist is a medical doctor who can prescribe medication. A psychologist holds a doctorate and provides therapy and testing. Therapist is a broader term for licensed master's-level professionals who provide talk therapy. Most psychologists and therapists don't prescribe."
intro: "These titles get used interchangeably, but they mean different training, different roles, and crucially, different answers to whether someone can prescribe medication."
terms:
  - name: "Psychiatrist"
  - name: "Psychologist"
  - name: "Therapist"
table:
  - dimension: "Training"
    values: ["Medical degree (MD or DO) plus psychiatry residency", "Doctorate in psychology (PhD or PsyD)", "Master's degree plus clinical licensure"]
  - dimension: "Can prescribe medication?"
    values: ["Yes", "Usually no (a few states with extra training)", "No"]
  - dimension: "Main role"
    values: ["Diagnosis and medication management, sometimes therapy", "Therapy and psychological testing", "Talk therapy and counseling"]
  - dimension: "Examples of titles"
...
network_links:
  - site: shrinkmd
    ...
    label: "See a psychiatrist at shrinkMD"
  - site: shrinkopedia
    url: "https://shrinkopedia.com/"
    label: "Encyclopedia depth on Shrinkopedia"
sources:
  - title: "What Is Psychiatry?"
    publisher: "American Psychiatric Association"
    url: "https://www.psychiatry.org/patients-families"
  - title: "Mental Health Care: Who's Who"
