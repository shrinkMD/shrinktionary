...
slug: sadness-vs-depression
short_answer: "Sadness is a normal emotion that's tied to a cause and lifts with time. Depression is a persistent medical condition: low mood and loss of interest most of the day, nearly every day, for at least two weeks, with real effects on function."
intro: "Everyone feels sad. Depression is something else. The difference is in how long it lasts, how much it spreads across life, and whether it lifts."
terms:
  - name: "Sadness"
  - name: "Depression"
    slug: depression
table:
  - dimension: "What it is"
    values: ["A normal, healthy emotion", "A recognized medical condition"]
  - dimension: "Duration"
    values: ["Comes and goes, often with a cause", "Most of the day, nearly every day, 2+ weeks"]
  - dimension: "Reach"
    values: ["You can still enjoy other things", "Interest and pleasure fade across the board"]
  - dimension: "Body and function"
    values: ["Usually intact", "Sleep, appetite, energy, focus, and function affected"]
  - dimension: "Lifts?"
