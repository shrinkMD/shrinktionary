---
title: "Intrusive thoughts vs compulsions"
slug: intrusive-thoughts-vs-compulsions
short_answer: "An intrusive thought is an unwanted thought, image, or urge that pops into your mind. A compulsion is something you do, a behavior or mental act, to relieve the distress that thought creates. In OCD, the first drives the second."
intro: "These two are the two halves of the obsessive-compulsive cycle. Telling them apart makes the cycle visible, which is the first step to interrupting it."
terms:
...
table:
  - dimension: "What it is"
    values: ["An unwanted thought, image, or urge", "A repeated behavior or mental act"]
  - dimension: "Wanted?"
    values: ["No, it feels intrusive and distressing", "No, but it feels necessary to relieve distress"]
  - dimension: "Role in OCD"
    values: ["The obsession that starts the cycle", "The response meant to neutralize it"]
  - dimension: "Effect"
...
network_links:
  - site: anxietyresource
    ...
    label: "Read more at AnxietyResource"
  - site: shrinkmd
