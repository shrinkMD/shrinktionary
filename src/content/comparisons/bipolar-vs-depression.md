...
short_answer: "Depression (unipolar) means the mood only goes down. Bipolar disorder means the mood also goes up, into mania or hypomania. The depressed phases can look identical, which is why bipolar disorder is often missed at first."
intro: "From the outside, a depressive episode in bipolar disorder and one in major depression can look the same. The difference is the history of highs, and getting it right changes the whole treatment plan."
terms:
  ...
  - name: "Depression"
    slug: depression
table:
  - dimension: "Mood pattern"
    values: ["Lows and highs (mania or hypomania)", "Lows only"]
  - dimension: "The highs"
    values: ["Elevated mood, less need for sleep, racing thoughts, risk-taking", "Not present"]
  - dimension: "First-line medication"
    values: ["Mood stabilizers; antidepressants alone can be risky", "Antidepressants are a common first-line option"]
