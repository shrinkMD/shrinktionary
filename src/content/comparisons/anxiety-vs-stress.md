...
short_answer: "Stress is the response to a real, present demand, and it eases when the demand passes. Anxiety can show up without a current trigger and stick around after the stressor is gone."
intro: "Stress and anxiety feel similar and often travel together, but they aren't the same thing. The clearest difference is what they're attached to and whether they fade when life calms down."
terms:
  - name: "Anxiety"
    slug: anxiety
  - name: "Stress"
table:
  - dimension: "Trigger"
    values: ["May have no clear or current trigger", "A specific, present demand or pressure"]
  - dimension: "Time course"
    values: ["Can persist or return without cause", "Eases when the stressor passes"]
  - dimension: "Focus"
    values: ["Future-oriented: what might go wrong", "Present-oriented: the demand in front of you"]
