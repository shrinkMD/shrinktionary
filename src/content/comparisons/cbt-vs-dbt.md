...
title: "CBT vs DBT"
slug: cbt-vs-dbt
short_answer: "CBT is a broad therapy focused on changing unhelpful thoughts and behaviors. DBT is a specialized form of CBT built for intense emotions, adding skills for distress tolerance, emotion regulation, and acceptance."
intro: "DBT grew out of CBT, so they share a foundation, but they're aimed at different problems. CBT targets thinking and behavior; DBT targets overwhelming emotion."
terms:
  - name: "CBT"
    slug: cbt
  - name: "DBT"
...
table:
  - dimension: "Core focus"
    values: ["Identifying and changing unhelpful thoughts and behaviors", "Managing intense emotions and reducing harmful behaviors"]
  - dimension: "Developed for"
    values: ["Depression, anxiety, OCD, and many conditions", "Borderline personality disorder, self-harm; now broader"]
  - dimension: "Signature elements"
    values: ["Thought records, behavioral experiments, exposure", "Mindfulness, distress tolerance, emotion regulation, interpersonal skills"]
  - dimension: "Balance"
    values: ["Emphasis on change", "Balance of acceptance and change"]
  - dimension: "Format"
...
network_links:
  ...
  - site: shrinkmd
    url: "https://shrinkmd.com/therapy/"
    label: "Therapy at shrinkMD"
sources:
