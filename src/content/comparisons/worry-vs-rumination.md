...
short_answer: "Worry looks forward and asks 'what if?' about things that might happen. Rumination looks back and asks 'why?' about things that already did. Both are repetitive loops, but they point in opposite directions."
intro: "Worry and rumination are both forms of repetitive thinking that feel productive and aren't. The tell is which way they face in time."
terms:
  - name: "Worry"
  - name: "Rumination"
    slug: rumination
table:
  - dimension: "Direction in time"
    values: ["Future: what might go wrong", "Past or present: why something happened"]
  - dimension: "Core question"
    values: ["What if?", "Why? What's wrong with me?"]
  - dimension: "Most tied to"
    values: ["Anxiety", "Depression"]
  - dimension: "What it feels like"
    values: ["Bracing for a threat", "Replaying and self-criticizing"]
...
network_links:
  - site: shrinq
    ...
    label: "Spot the pattern with shrinQ"
  - site: shrinkmd
